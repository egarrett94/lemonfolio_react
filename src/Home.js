				...
				<section className="se-container">
					<div className="se-slope">
						<article className="se-content name-section">
							...
							<marquee behavior="scroll" direction="left" className="marquee" scrollamount="3">
								Full Stack Web Dev <span className="white-text">|</span> Artist Extraordinaire{' '}
								<span className="white-text">|</span> Dog Petting Champion
							</marquee>
							<br />
							<a href="http://www.github.com/egarrett94">
								<i id="github" className="fa fa-github social" />
							</a>
							<a href="http://www.linkedin.com/in/emilymariegarrett94">
								<i id="linkedin" className="fa fa-linkedin social" />
							</a>
							<a href="mailto:e.marie.garrett@gmail.com">
								<i id="email" className="fa fa-envelope social" />
							</a>
							<br />
							<span className="grey-text">(Contact me.)</span>
							<br />
							<a href={Resume} target="_blank">
								<i className="material-icons social">file_download</i>
							</a>
							<br />
					...
					<div className="se-slope">
						<article className="se-content">
							...
							<p>
								I am passionate about taking the opportunity to utilize the endless resources that
								technology provides to help those in need. I deeply believe in using technology for more
								than just creating the slickest new product or game; I believe in employing it to
								promote inclusivity and create change.{' '}
							</p>
						</article>
					</div>
					<div className="se-slope">
							...
							<div className="form-container col s12 m8 offset-m2">
								<div className="col s6 offset-s3">
									<form
										...
										action="https://formspree.io/e.marie.garrett@gmail.com"
										method="POST"
									>
										<label htmlFor="name">Your Name: </label>
										<input
											type="text"
											className="browser-default inputs"
											name="name"
											placeholder="ex: Jane Doe, My Company Inc."
										/>
										<br />
										...
										<input
											...
											className="browser-default inputs"
											name="_replyto"
											placeholder="ex: dogs_r_great@example.com"
										/>
										<br />
										...
										<input
											type="text"
											name="_subject"
											className="browser-default subject"
											defaultValue="Hey!"
											placeholder="Hey! You're great!"
										/>
										<textarea
											name="message"
											className="browser-default textareainput"
											placeholder="Hello there, Lemon, let's chat!"
										/>
